...
class Config(object):
    ...
    OWNER_ID = 816833525  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Arjuvk"
    SUPPORT_CHAT = 'RM_MOVIESGROUP'  #Your own group for support, do not add the @
